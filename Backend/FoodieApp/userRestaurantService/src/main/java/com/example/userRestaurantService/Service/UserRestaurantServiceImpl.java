...
public class UserRestaurantServiceImpl implements UserRestaurantService {
    ...
    public User registerUser(CommonUser commonUser) throws UserAlreadyExistException {
        User user = new User(commonUser.getEmailId(), commonUser.getProfilePicture(), commonUser.getFirstName(), commonUser.getLastName(), commonUser.getRole(), commonUser.getPassword(), new ArrayList<>(), new ArrayList<>());
